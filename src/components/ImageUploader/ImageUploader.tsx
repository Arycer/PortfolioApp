            ...
            >
                ...
                {isUploading ? (
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                        {preview ? (
                            <div
                                className="mx-auto w-48 h-48 overflow-hidden rounded-lg border border-slate-600 shadow-lg">
                                <img
                                    src={preview}
                                    alt="Vista previa"
                                    className="w-full h-full object-contain bg-slate-900/50"
                ...
                {error && (
                    <div
                        className="mt-4 text-sm text-red-400 bg-red-900/20 py-2 px-4 rounded-lg border border-red-800/30 max-w-xl mx-auto">
